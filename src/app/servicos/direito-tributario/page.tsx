    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="w-full pt-24 sm:pt-32 pb-16 sm:pb-20 px-4 sm:px-6 bg-linear-to-br from-slate-50 to-white">
        <div className="container mx-auto max-w-6xl">
          <ScrollReveal delay={0.1}><div className="mb-4"><Link href="/" className="text-sm text-[#27444C]600 hover:text-[#27444C]700 transition-colors">← Voltar para home</Link></div></ScrollReveal>
          <ScrollReveal delay={0.2}><span className="inline-block px-4 py-1.5 bg-teal-50 rounded-full text-xs sm:text-sm font-semibold uppercase tracking-wider mb-6" style={{ color: '#5A9FA9' }}>Área de Atuação</span></ScrollReveal>
          <ScrollReveal delay={0.3}><h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-slate-900 mb-6 max-w-4xl">Direito <span className="font-semibold" style={{ color: '#5A9FA9' }}>Tributário</span></h1></ScrollReveal>
          <ScrollReveal delay={0.4}><p className="text-lg sm:text-xl text-white/90 leading-relaxed max-w-3xl">Otimização fiscal e recuperação de créditos tributários para empresas e pessoas físicas.</p></ScrollReveal>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            <div className="lg:col-span-2 space-y-8">
              <ScrollReveal delay={0.1}>
                <div className="prose prose-lg max-w-none">
                  <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4">Sobre a Área</h2>
                  <p className="text-white/90 leading-relaxed mb-4">O Direito Tributário visa otimizar a carga fiscal de empresas e indivíduos através de planejamento tributário legal, recuperação de créditos e defesa em processos fiscais.</p>
                  <p className="text-white/90 leading-relaxed mb-4">Oferecemos consultoria para escolha do melhor regime tributário (Simples Nacional, Lucro Presumido ou Lucro Real), análise de incentivos fiscais e estratégias de elisão fiscal.</p>
                  <p className="text-white/90 leading-relaxed">A recuperação tributária permite reaver valores pagos indevidamente nos últimos 5 anos, através de procedimentos administrativos ou judiciais.</p>
                </div>
              </ScrollReveal>
              ...
              <ScrollReveal delay={0.3}>
                <div><h2 className="text-2xl sm:text-3xl font-bold text-white mb-6">Serviços Oferecidos</h2>
                  <div className="bg-white rounded-xl p-6 sm:p-8 border border-slate-200"><div className="grid grid-cols-1 sm:grid-cols-2 gap-4">{services.map((service) => (<div key={service} className="flex items-start gap-3"><CheckCircle2 className="w-5 h-5 text-[#27444C]500 shrink-0 mt-0.5" /><span className="text-slate-700">{service}</span></div>))}</div></div>
                </div>
              </ScrollReveal>
            </div>
            <div className="lg:col-span-1">
              <div className="sticky top-24 space-y-6">
                ...
                <ScrollReveal delay={0.5}><div className="bg-white rounded-xl p-6 border border-slate-200"><h3 className="text-lg font-semibold text-slate-900 mb-4">Outras Áreas</h3><div className="space-y-3"><Link href="/servicos/direito-trabalhista" className="block text-sm text-slate-600 hover:text-[#27444C]600 transition-colors">Direito Trabalhista</Link><Link href="/servicos/direito-digital" className="block text-sm text-slate-600 hover:text-[#27444C]600 transition-colors">Direito Digital</Link><Link href="/servicos/direito-publico" className="block text-sm text-slate-600 hover:text-[#27444C]600 transition-colors">Direito Público</Link><Link href="/areas-atuacao" className="block text-sm text-[#27444C]600 hover:text-[#27444C]700 font-medium transition-colors">Ver todas as áreas →</Link></div></div></ScrollReveal>
              </div>
            </div>
          </div>
        </div>
