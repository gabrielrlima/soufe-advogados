        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <ScrollReveal delay={0.3}>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-slate-900 mb-6 max-w-4xl">
              Direito do <span className="font-semibold" style={{ color: '#5A9FA9' }}>Consumidor</span>
            </h1>
          </ScrollReveal>

          <ScrollReveal delay={0.4}>
            <p className="text-lg sm:text-xl text-slate-600 leading-relaxed max-w-3xl">
              Defesa dos direitos dos consumidores nas relações de consumo, garantindo proteção contra práticas abusivas.
              ...
              <ScrollReveal delay={0.1}>
                <div className="prose prose-lg max-w-none">
                  ...
                  <p className="text-white/90 leading-relaxed mb-4">
                    O Direito do Consumidor regulamenta as atividades econômicas organizadas, abrangendo 
                  ...
                  <p className="text-white/90 leading-relaxed">
                    Atuamos na defesa de consumidores em casos de produtos defeituosos, serviços inadequados, cobranças indevidas, publicidade enganosa e demais violações ao CDC.
                ...
                <ScrollReveal delay={0.4}>
                  ...
                  >
                    ...
                    <p className="text-white/90 text-sm mb-6">
                      Entre em contato com nossos especialistas em Direito do Consumidor.
                    </p>
