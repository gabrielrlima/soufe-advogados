...
import { Phone, Mail, MapPin, CheckCircle2, Briefcase, Users, Scale, Building2, FileText } from "lucide-react";
...
export default function DireitoAdministrativoPage() {
  const services = [
    ...
    "Concursos públicos e recursos",
    "Improbidade administrativa",
    "Servidores públicos (aposentadoria, progressão)",
    "Mandados de segurança",
    "Desapropriação e servidão administrativa",
    "Direito regulatório e agências",
    "Concessões e PPPs",
  ...
  const expertise = [
    {
      icon: Building2,
      title: "Licitações",
      description: "Assessoria completa em processos licitatórios, desde habilitação até execução contratual."
    },
    {
      icon: Users,
      title: "Servidores",
      description: "Defesa de servidores públicos em processos disciplinares e questões funcionais."
    },
    {
      icon: Scale,
      title: "Contencioso",
      description: "Representação judicial e administrativa em ações contra o Poder Público."
    },
  ];
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          <ScrollReveal delay={0.3}>
            <h1 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-slate-900 mb-6 max-w-4xl">
              Direito <span className="font-semibold" style={{ color: '#5A9FA9' }}>Administrativo</span>
            </h1>
          </ScrollReveal>

          <ScrollReveal delay={0.4}>
            <p className="text-lg sm:text-xl text-slate-600 leading-relaxed max-w-3xl">
              Assessoria jurídica especializada nas relações entre cidadãos, empresas e a Administração Pública.
              ...
              <ScrollReveal delay={0.1}>
                <div className="prose prose-lg max-w-none">
                  ...
                  <p className="text-white/90 leading-relaxed mb-4">
                    O Direito Administrativo regulamenta as atividades econômicas organizadas, abrangendo 
                  ...
                  <p className="text-white/90 leading-relaxed">
                    Atuamos tanto de forma consultiva quanto contenciosa, representando clientes em licitações, contratos administrativos, processos disciplinares, concursos públicos e questões regulatórias.
                ...
                <ScrollReveal delay={0.4}>
                  ...
                  >
                    ...
                    <p className="text-white/90 text-sm mb-6">
                      Entre em contato com nossos especialistas em Direito Administrativo.
                    </p>
              ...
              <ScrollReveal delay={0.2}>
                <div>
                  ...
                  <ul className="space-y-3 text-sm text-slate-400">
                    <li><Link href="/servicos/direito-administrativo" className="hover:text-[#27444C]400 transition-colors">Direito Administrativo</Link></li>
                    <li><Link href="/servicos/direito-consumidor" className="hover:text-[#27444C]400 transition-colors">Direito do Consumidor</Link></li>
